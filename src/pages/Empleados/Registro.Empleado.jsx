...
const RegistroEmpleado = ({ empleado, setRefreshCheckLogin, setShowModal }) => {
  ...
  const [tiendasList, setTiendasList] = useState([]); // Si necesitas manejar tiendas
  // Aquí podrías cargar las tiendas disponibles si es necesario
  useEffect(() => {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          >
            ...
            {/* Aquí deberías mapear las tiendas disponibles desde tu estado o props */}
            {/* Ejemplo: */}
